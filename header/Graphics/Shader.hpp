...
public:
	...
	*/
	void loadFromMemory(const char* data, Shader::Type type, std::string* message);
	...
	*/
	void loadFromFile(const char* filename, Shader::Type type, std::string* message);
	...
	*/
	Shader link(std::string* message);
};
